...
class LibraryApplicationTests {
	...
	void test_read_all() {
		...
		Assertions.assertThat(response.getBody()).isNotNull().hasSize(5)
	...
	void test_list_with_filter_1() {
		...
		// --------------- Then ---------------
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
		Assertions.assertThat(response.getBody()).hasSize(2).allMatch(library -> library.type.equals(Type.NATIONAL));
	}
	...
	void test_list_with_filter_2() {
		...
		// --------------- Then ---------------
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
		Assertions.assertThat(response.getBody()).hasSize(3).allMatch(library -> library.directorDTO.surname.equals("Garfield"));
	}
}